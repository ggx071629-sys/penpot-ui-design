#!/usr/bin/env node
import "./workspace-guard.mjs"; // Local customization protection.
/**
 * install-behavior.mjs — wire a client to USE the installed seed (AGENTS.md + skills + workflows + prompts).
 *
 * B2 model: points at the SEED (kitHome, default penpot-kit), not the disposable clone. Writes the
 ...
 *   --kit-path <abs>    seed location (default: kitHome / penpot-kit) · --target-dir <abs> (default cwd)
