 ...
 * location (kitHome, default penpot-kit). Everything else (MCP secret, behavior pointers) is
...
export const kitHome = () => KIT_SOURCE; // Project-local authority; no global/env destination.
